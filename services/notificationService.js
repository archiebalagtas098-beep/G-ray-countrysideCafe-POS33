...
class NotificationService {
    ...
    async sendTestEmail(email) {
        const htmlContent = `
            <div style="font-family: Arial, sans-serif; background-color: #f5f5f5; padding: 20px;">
                <div style="background-color: white; padding: 20px; border-radius: 8px; max-width: 600px; margin: 0 auto;">
                    <h2 style="color: #27ae60;">✓ Test Email Success!</h2>
                    <p>This is a test email from the G'RAY COUNTRYSIDE CAFÉ POS System.</p>
                    
                    <h3 style="color: #555;">Configuration Details:</h3>
                    <ul style="color: #666;">
                        <li>Email Service: Gmail SMTP</li>
                        <li>Sent To: ${email}</li>
                        <li>Time: ${new Date().toLocaleString('en-PH', { timeZone: 'Asia/Manila' })}</li>
                    </ul>
        ...
        return await this.sendEmailToAdmin(email, 'Test Email - Configuration Successful', htmlContent);
    }
}
